<template>
    ...
    <!-- Properties -->
    <div
      class="rounded-lg p-5 relative w-full max-xs:h-90 xs:aspect-square flex flex-col justify-end items-start text-white overflow-hidden"
...
const visibleApartments = computed(() =>
  props.apartments.slice(0, visibleCount.value)
)

const hasMore = computed(() =>
  visibleCount.value < props.apartments.length
)
